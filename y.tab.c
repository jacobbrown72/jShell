...
static const char *const yytname[] =
{
  ...
  "ALIAS", "UNALIAS", "BYE", "LT", "GT", "VERT", "QUOTE", "WACK", "AMP",
  "WORD", "WHITESPACE", "$accept", "cmd", "built_in", "other", YY_NULLPTR
};
#endif
...
#line 40 "shell.y" /* yacc.c:1646  */
    {printf("alias command received\n");}
#line 1261 "y.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 41 "shell.y" /* yacc.c:1646  */
    {printf("unalias command received\n");}
...
#line 44 "shell.y" /* yacc.c:1646  */
    {fprintf(stdout, "%s command received\n", cmd);}
